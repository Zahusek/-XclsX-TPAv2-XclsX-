package com.gmail.zahusek.tinyprotocolapi.utility;
...
public final class Reflection {
	...
	public static String VERSION = OBC_PREFIX.replace(
	...
	public static Accessor[] getField(Class<?> target) {
		List<Accessor> fields = Lists.newArrayList();
		...
		return fields.toArray(new Accessor[0]);
	}
	...
	public static Object getHandle(Object handle) {
		try {
			return handle.getClass().getMethod("getHandle").invoke(handle);
		} catch (Exception e) {
			throw new IllegalArgumentException("Cannot find "
					+ handle.getClass().getName(), e);
		}
	}
